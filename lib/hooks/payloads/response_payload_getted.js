...
function get_fail_getted_response (req) {
  const payload = get_success_standard_response(
    req.getted_successful_message,
    req.errors,
    400)
...
module.exports.get_fail_getted_response = get_fail_getted_response
